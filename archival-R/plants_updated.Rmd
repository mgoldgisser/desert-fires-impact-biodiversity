...
plants <- read_csv("data/plants_burned.csv") %>% 
...
#removed "Coleogyne" and "Atriplex" excluded because highly correlated with Opuntia
native_genus <- c("Ephedra", "Opuntia", "Ambrosia", "Olneya", "Carnegiea", "Larrea", "Yucca")
...
autoplot(all.pca, data=data2mat, colour = "pre_or_post", loadings = TRUE, 
         loadings.label = TRUE, loadings.label.size = 3,loadings.label.vjust = c(), loadings.label.hjust = c(), legend.title = "none") + 
  geom_point(size = 3, color = c("darkslateblue", "red3", "darkslateblue", "red3",  "red3", "red3", "red3", 
                                 "darkslateblue", "red3", "red3", "darkslateblue", "red3", "darkslateblue", 
                                 "darkslateblue", "red3", "darkslateblue", "red3", "darkslateblue")) + 
