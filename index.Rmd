...
p1 <- ggplot(ndvi, aes(x = fct_rev(factor(treatmentGroup)), y = ndvi, color = desert)) +
...
plot_grid(p2, p1, cols = 2, labels = "AUTO", align = "h", axis = "tb")
p5
...
#all
glmm2 <- glmmTMB(stzd_Occ ~ obsYear + ndvi * treatmentGroup + (1|desert), 
               data = data1,
               family = "nbinom2")
summary(glmm2)
