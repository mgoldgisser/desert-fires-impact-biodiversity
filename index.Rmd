...
#   burned adjusted means are higher than control adjusted means with p-value <0.0001


plot(emm_pp[[1]], xlab = "Difference in log(average occurrences in 5-yr period)")
```
...
## overtime
```{r overtime birds only, include=FALSE}
##no pseudo-absence
