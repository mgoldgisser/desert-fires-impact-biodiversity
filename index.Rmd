...
p2 <- animals %>% 
  ...
  ylab(bquote('Average Yearly Occurrences \nReported per 1,000'~km^2)) +
  theme_bw() + 
  theme(axis.text.y = element_text(size = 12), 
        axis.text.x = element_text(size = 12),
...
plot_grid(p3, p4, rel_widths = c(1,1.4), labels = c("Aves", "Other ES"), align = "h")
plot_grid(p1, p2, p5, cols = 2, labels = "AUTO", scale = c(.9, .9, .9))
